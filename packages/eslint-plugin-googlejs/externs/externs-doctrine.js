...
/** @type {!Doctrine.Type} */ Doctrine.Tag.prototype.type;
...
/** @type {key} */ Doctrine.FieldType.prototype.type;
/** @type {value} */ Doctrine.FieldType.prototype.type;
...
/** @type {!Doctrine.Type} */ Doctrine.FunctionType.prototype.result;
/** @type {(!Doctrine.Type|undefined)} */ Doctrine.FunctionType.prototype.this;
...
/** @type {!Doctrine.Type} */ Doctrine.ParameterType.prototype.expression;

/** @record */ Doctrine.RestType = function() {};
/** @type {string} */ Doctrine.RestType.prototype.type;
/** @type {!Doctrine.Type} */ Doctrine.RestType.prototype.Expression;

/** @record */ Doctrine.NonNullableType = function() {};
/** @type {string} */ Doctrine.NonNullableType.prototype.type;
/** @type {!Doctrine.Type} */ Doctrine.NonNullableType.prototype.expression;
...
/** @type {!Doctrine.Type} */ Doctrine.OptionalType.prototype.expression;

/** @record */ Doctrine.NullableType = function() {};
/** @type {string} */ Doctrine.NullableType.prototype.type;
/** @type {!Doctrine.Type} */ Doctrine.NullableType.prototype.expression;
...
/** @type {!Doctrine.Type} */ Doctrine.TypeApplication.prototype.expression;
 ...
 */
Doctrine.Parser.prototype.parse = function(comment, options) {};
